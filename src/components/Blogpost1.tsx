        ...
        <div className='container'>
          ...
          <div className='row'>
            ...
            <div className='col-lg-8'>
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยธนพล อิศรางกูร ณ อยุธยา</p>
              <hr />
              {/* Post Content */}
              <p className='lead'>
                แนวคิดปรัชญากับการพัฒนาองค์การ
                <p> แนวคิดปรัชญากับการพัฒนาองค์การ ได้แก่</p>{' '}
              ...
              <p className='lead'>
                ...
                <p> OD ได้รับอิทธิพลองค์ความรู้มาจากศาสตร์ที่หลากหลาย</p>
                <ul className='ml-4' style={{ listStyleType: 'lower-roman' }}>
                  <li>จิตวิทยาสังคม (Social Psychology) (KPI)</li>
                  <li>กระบวนการกลุ่ม (Group Dynamics)</li>
                  <li>
                    จิตวิทยาอุตสาหกรรมและองค์การ (Industrial and Organization
                    Psychology)
                  </li>
                  <li>ทฤษฎีการจัดการแบบมีส่วนร่วม (Participative)</li>
              ...
              <p className='lead'>
                ...
                <p>ธรรมชาติของ OD (The Nature of OD)</p>
                <ul className='ml-4'>
                  <li>
                    1. OD เกี่ยวข้องศาสตร์หลายแขนง โดยมี Behavioral Sciences
                    เป็นแกนกลางหรือแกนหลัก (KPI)
                  </li>
                  <li>
                    2. เป้าหมายหลักของ OD คือปรับปรุงประสิทธิผลขององค์การ (Group
                    Dynamics)
                  </li>
                  <li>
                    3. ขอบเขตของการทำ OD คือทำทั่วทั้งระบบ ได้แก่ ฝ่าย แผนกกลุ่ม
                    บุคคล ชุมชน ประเทศ ภูมิภาค
                  </li>
                  <li>
                    {' '}
                    4. OD ตระหนักถึงความมุ่งมั่น สนับสนุน
                    และการมีส่วนร่วม(Participative){' '}
                  </li>
              ...
              <p className='lead'>
                ลักษณะสำคัญของ OD
                <ul className='ml-4'>
                  <li>1. OD เกี่ยวข้องกับการเปลี่ยน แปลงกลยุทธ์ (KPI)</li>
                  <ul className='ml-4'>
                    <li>
                      โครงสร้างและ/หรือกระบวนการของระบบทั้งระบบมีความหมายครอบคลุมตั้งแต่องค์การฝ่ายหรือกลุ่มงาน
                    </li>
                  </ul>
                  <li>
                  ...
                  <ul className='ml-4'>
                    <li>
                      ภาวะผู้นำ กระบวนการกลุ่ม การออกแบบงาน กลยุทธ์
              ...
              <p className='lead'>
                ...
                <ul className='ml-4'>
                  ...
                  <li>
                    ...
                    <ul className='ml-4'>
                      <li>
                        1.มุ่งพัฒนารูปแบบการทำงานที่ให้ความสำคัญกับความสอดคล้องระหว่างเทคโนโลยีกับมนุษย์
                      </li>
              ...
              <p className='lead'>
                ...
                <ul className='ml-4'>
                    ...
                    <ul className='ml-4'>
                      <li>
                        ...
                        <ul className='ml-4'>
                          ...
                          <li>
                            -กระบวนการพัฒนาองค์การการทำให้องค์การมีความพร้อมสำหรับการเปลี่ยนแปลงไปสู่สถานะใหม่ที่ดีขึ้น
                  ...
                  <li>
                    2.รูปแบบ Action Research (Action Research Model) Action
                    Research (การวิจัยเชิงปฏิบัติการ)
                    ...
                    <p>
                      <strong>Action Research มี 8 ขั้นตอน ดังนี้</strong>
                    </p>
                    <ul className='ml-4'>
                      <li>
                      ...
                      <li>
                        ...
                        <ul className='ml-4'>
                          ...
                          <li>
                            ...
                            (Virtuousness) และการยกระดับกระบวนการต่างๆ
                            (Elevating Process)เช่น
                        ...
                        <li>
                          ...
                          <ul className='ml-4'>
                            ...
                            <ul className='ml-4'>
                              ...
                              <li>
                                -ความสัมพันธ์ระหว่างบุคคลในอยู่ในภาวะเลวร้าย
                              </li>
                            </ul>
                            ...
                            <ul className='ml-4'>
                              <li>
                                -สถานะที่ปฏิบัติหน้าที่ได้ดีเลิศ (An
                                Extraodinarily Function State)
                              </li>
                              <li>
                              ...
                              <li>
                                -การสร้างพลังบวกเพื่อนำไปสู่การเปลี่ยน แปลง
                              </li>
                            </ul>
                          </ul>
                        </li>
              ...
              <p className='lead'>
                ...
                <ul className='ml-4'>
                  <li>บุคคลที่มีบทบาทต่อการเปลี่ยนแปลงองค์การ มีดังนี้</li>
                  <li>
              ...
              <p className='lead'>
                ...
                <ul className='ml-4'>
                  <li>
                    1. ที่ปรึกษาภายนอก
                    ได้แก่บุคคลที่ได้รับการว่าจ้างให้ช่วยเปลี่ยนแปลงองค์การ
                  ...
                  <li>
                    ...
                    หรือที่ปฏิบัติงานด้านอื่นร่วม เช่นงานด้านฝึกอบรม
              ...
              <p className='lead'>
                ...
                <ul className='ml-4'>
                  <li>
                    ...
                    ความรับผิดชอบในการให้ความช่วยเหลือผู้อื่นการสร้างความสมดุลระหว่างเหตุผลและอารมณ์
                  ...
                  <li>
                    ...
                    Theory) (Interpersonal Skills)
                  </li>
                  <li>
                    5. เป็นนักวิเคราะห์ (Diagnostician) (Interpersonal Skills)
                  </li>
                  <li>
                  ...
                  <li>
                    7. เป็นนักเปลี่ยนแปลง (Interventionist) (Interpersonal
                    Skills)
                  </li>
                  <li>
                  ...
                  <li>
                    9. เป็นผู้อำนวยความสะดวก (Facilitator) (Interpersonal
                    Skills)
                  </li>
                  <li>10. เป็นผู้ฝึกสอน (Coach) (Interpersonal Skills)</li>
                </ul>
              </p>
              <p className='lead'>
